...
class CustomLockScrollPhysics extends ScrollPhysics {
  ...
  /// If it is a user gesture, [applyPhysicsToUserOffset] is called before
  /// [applyBoundaryConditions];
  ///
  /// If it is a programming gesture eg. `controller.animateTo(index)`,
  /// [applyPhysicsToUserOffset] is not called.
  bool _lock = false;
    ...
    assert(() {
      if (value == position.pixels) {
        throw FlutterError(
            ...
            'The proposed new position, $value, '
